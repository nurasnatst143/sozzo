...
const page = () => {
	return (
		<div>
			...
			<div className='relative h-screen w-full bg-white bg-no-repeat bg-center bg-cover'>
				<div className='  max-w-[1400px] mx-auto px-2 min-h-[80vh] flex justify-center items-center '>
					<div className='bg-black/20 backdrop-blur-md  mt-3 shadow-md border border-white/20 mx-auto p-8 w-full md:w-[35vw] min-w-[300px] rounded-md'>
